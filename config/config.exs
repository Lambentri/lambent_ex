...
config :lambent_ex, LambentExWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: LambentExWeb.ErrorHTML, json: LambentExWeb.ErrorJSON],
    layout: false
  ],
...
config :esbuild,
  ...
  default: [
    args:
      ~w(js/app.js css/fonts/TF2Build.css --bundle --loader:.woff2=file --loader:.woff=file --target=es2017 --outdir=../priv/static/assets --external:/fonts/* --external:/images/*),
